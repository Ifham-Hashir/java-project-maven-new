...
<head>
    ...
    <!-- ------------------ Title ------------------ -->
    <title>Disney+ Hotstar - Watch the TV Shows Online</title>
        ...
        <div class="carousel">
            <!-- <div class="slider">
                <div class="slide-content">
                    ...
                    <p class="movie-des">Lorem ipsum title messi, sit amet consectetur adipisicing elit. Quam distinctio molestiae quis praesentium cum obcaecati eveniet voluptates exercitationem eum accusantium.</p>
                </div>
